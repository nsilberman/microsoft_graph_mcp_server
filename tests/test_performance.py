        ...
        for size in test_sizes:
            ...
            for i in range(size):
                ...
                await email_client.post(
                    f"/me/mailFolders/{source_folder_id}/messages", data=message_data
                )
            ...
            await graph_client.move_all_emails_from_folder(
                destination_folder, source_folder
            )

            print(f"Cleaning up emails...")
            source_folder_id = await email_client._get_folder_id_by_path(source_folder)
            result = await email_client.get(
                f"/me/mailFolders/{source_folder_id}/messages",
