...
s1 = asyncio.run(auth_manager.complete_auth())
print(f"   Status: {s1['status']}")
print(f"   Message: {s1['message'][:80]}...")

print("\n2. Initiating login...")
l1 = asyncio.run(auth_manager.start_auth())
...
print("  3. Run complete_auth again with the device_code")
print("=" * 70)
